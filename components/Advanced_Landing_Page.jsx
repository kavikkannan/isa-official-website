...
import TitleComponent from './LandingComponents/TitleComponent'
import AboutUsComponent from './LandingComponents/AboutUsComponent'
import UspComponent from './LandingComponents/UspComponent'
import TracingBeam from './ui/TracingBeam'
import SignInButton from './LandingComponents/SignInButton'
                ...
                <div>
                    <AnimatePresence>
                        <div className="flex flex-col">
                            {/* <Logo /> */}
                            <Navbar />
                            <TitleComponent className="w-full h-full" />
                            <SparklesCore
                                ...
                                maxSize={0.9}
                                particleDensity={15}
                                className="w-full h-full opacity-20 top-0 left-0 absolute"
